...
const Page = () => {
    return (
        <div className="min-h-screen w-full overflow-x-hidden bg-[#1e1e1e] flex flex-col py-8 md:py-0">
            <div className="text-center mt-12 md:mt-30 mb-6 md:mb-10 px-4">
                <h2 className="text-3xl sm:text-4xl md:text-5xl font-extrabold tracking-tight text-white drop-shadow-[1px_1px_0_#000000] md:drop-shadow-[2px_2px_0_#000000]">
                    Commit Activity
                </h2>
            ...
            <div className="flex-1 flex flex-col lg:flex-row items-center justify-center gap-6 md:gap-8 lg:gap-12 px-4 sm:px-6 md:px-8 lg:px-12">
                <div className="w-full max-w-4xl flex justify-center order-2 lg:order-1">
                    <div className="w-full bg-[#1e1e1e] shadow-[4px_4px_0_#ffffff] sm:shadow-[6px_6px_0_#ffffff] md:shadow-[8px_8px_0_#ffffff] rounded-xl p-4 sm:p-6">
                        <CommitChart />
                    </div>
                </div>
                ...
                <ul className="w-full lg:w-1/2 space-y-4 md:space-y-6 lg:space-y-8 list-none text-left order-1 lg:order-2">
                    <li className="group flex items-start gap-3">
                        <span className="mt-2 h-2 w-2 rounded-full bg-white group-hover:scale-125 transition-transform duration-300 flex-shrink-0"></span>
                        <p className="text-base sm:text-lg md:text-xl lg:text-[1.25rem] leading-relaxed text-white font-medium tracking-tight">
